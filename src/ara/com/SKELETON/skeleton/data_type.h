...
{
public:
    constexpr InstanceIdentifier(const ara::com::SKELETON::InstanceId id)
        : m_instance_id(id)
    {
    }
    ...
    std::string toString() const
    {
        ...
        if (m_instance_id == ara::com::SKELETON::INSTANCE_ID_UNKNOWN)
        {
            ss << "Any";
        }
        else
    ...
    ara::com::SKELETON::InstanceId GetInstanceId() const
    {
    ...
    explicit operator ara::com::SKELETON::InstanceId() const
    {
        return m_instance_id;
    }
...
private:
    ...
    ara::com::SKELETON::InstanceId m_instance_id;    
};
...
{
    SKELETON::ServiceId service_id;
    SKELETON::InstanceId instance_id;
    std::uint32_t uid;
