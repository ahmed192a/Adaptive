...
namespace ara
{
    namespace com
    {
        ...
        namespace entry
        {
            ...
            private:
                EntryType GBType;
                std::vector<option::Option *> GBFirstOptions;
                std::vector<option::Option *> GBSecondOptions;
                uint16_t GBServiceId;
                uint16_t GBInstanceId;
                uint8_t GBMajorVersion;
                uint32_t GBTTL;

            protected:
                /// @brief Any service major version
                static const uint8_t AnyMajorVersion = 0xff;
                ...
                Entry(EntryType type,
                      ...
                      uint16_t instanceId,
                      uint32_t ttl,
                      uint8_t majorVersion = AnyMajorVersion) noexcept;
