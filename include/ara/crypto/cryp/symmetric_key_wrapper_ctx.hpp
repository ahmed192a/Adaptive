    ...
    namespace crypto {
        namespace cryp {
            ...
            enum class SymmetricKeyWrapperCtx_Status : std::uint8_t 
            {
             ...
             //SymmetricKeyWrapperCtx_Status status = SymmetricKeyWrapperCtx_Status::notInitialized;
            ...
            public:
                ...
                virtual void SetKey (const SymmetricKey &key, CryptoTransform transform) noexcept=0;
                
                /*Execute the "key unwrap" operation for provided BLOB and produce a Key object of expected type*/
                template <typename ExpectedKey>typename ExpectedKey::Uptrc UnwrapConcreteKey (ReadOnlyMemRegion wrappedKey, AlgId algId, AllowedUsageFlags allowedUsage) noexcept;
                ...
                virtual SymmetricKey::Uptr UnwrapKey (ReadOnlyMemRegion wrappedKey, AlgId algId, AllowedUsageFlags allowedUsage) const noexcept=0;
               ...
               // virtual SecretSeed::Uptrc UnwrapSeed (ReadOnlyMemRegion wrappedSeed, AlgId targetAlgId, SecretSeed::Usage allowedUsage) const noexcept=0;
                ...
                virtual std::vector<byte> WrapKeyMaterial (const SymmetricKey &key) const noexcept=0;
